...
\begin{figure}[h]
\centering
\includegraphics[width=15cm]{Figures/hydro/Figure_3.pdf}
\caption{Glacier-wide annual(a), seasonal winter (b) and summer (c) MB for Saint Sorlin glacier, with glaciological observations from the GLACIOCLIM observatory and simulated MB from J2K. Winter snowfall (d) and temperature (h), and summer snowfall (g) and temperature (i) are displayed in order to give context on the climate conditions for those years.} 
\label{hydro:fig2}
\end{figure*}
